...
The dataset would need to include employee data from companies that meet criteria to be labeled a startup. As there is not a clear-cut definition of what constitutes a startup, some assumptions will need to be made. For this project, LinkedIn's 2018 Top Startups list will be used to define the criteria that constitutes a startup. Companies must be independent and privately held, have 50 or more employees, be 7 years old or younger, and be headquartered in the country on whose list they appear. The dataset will be built from scraping techniques on LinkedIn. It will include names, location, summary, number of connections, and skills/endorsements of employees that work for companies on the Top 50 Startups list. The dataset will give insights into the most common majors, certifications, location, and work experience of these employees. The final project will be in the format of an R Markdown document, which will consist of the dataset, code written in R programming language, a report on the findings/insights gained, and visualizations of different graphs/charts to illustrate the insights.
